...
const PIXMAPS: Record<string, Pixmap> = {
  ...
  /*
   * Window chrome. Motif drew these as one-bit glyphs on the title bar buttons;
   * the Unicode stand-ins they replace (_ □ ▣ ×) came out a different size and
   * weight on every platform's font.
   */

  /* the system-menu bar at the left of a Motif title bar */
  sysmenu: [
    "................",
    "................",
    "................",
  ...
  /* iconify: a small square, the way a minimized window becomes an icon */
  minimize: [
    "................",
    "................",
    "................",
  ...
  /* restore: two frames, the front one lower and to the left */
  restore: [
    "................",
    "................",
    ".....#########..",
